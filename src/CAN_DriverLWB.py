...
########  end    ####################################
    ...
    data = (c_char*8)()
    data[0] = chr((current_x & 0x0F0000) >> 16)# byte3 低  >>左移运算，都需转换为当前值的最低位
    data[1] = chr((current_x & 0x00FF00) >> 8) # byte2 全
    data[2] = chr(current_x & 0x0000FF)# byte1 全
...
def CallbackSteer(msg1,msg2):
    ...
    desireDirDrive = msg1.desireDirDrive  #驾驶模式
    steerAngle_rx = msg2.steer_angle #转向角
...
if __name__ == '__main__':
    ...
    param_file = base_path + '/../params/paramLWB.yaml'
